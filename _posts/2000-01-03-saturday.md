  ...
  {% endif %}
    <div class="row activity-info-wrapper valign-wrapper">
      ...
      <div class="col m9 activity-info">
        ...
        <a class="waves-effect waves-light btn bg-{{ page.border-color }}" href="{{ activity.typeform }}" target="blank">Sign Up As a Mentor</a>
        {% endif %}
      </div>
    </div>
  </div>
  ...
  {% endif %}
    <div class="row activity-info-wrapper valign-wrapper">
      <div class="col m9 activity-info">
        ...
        <p class="col m12 activity-desc"> {{ activity.text }} </p>
        {% if activity.typeform %}
        <a class="waves-effect waves-light btn bg-{{ page.border-color }}" href="{{ activity.typeform }}" target="blank">Sign Up For Mentees / Participants</a>
        {% endif %}
      </div>
      <div class="col m3 activity-img valign">
        <img  src="img/{{ activity.image }}" alt="{{activity.title}}">

...
### But a sufficient knowledge of Git, Your Basic Tech Stack, Courtesy and Eagerness to Learn can go a Long Way

<div class="section-lines section-top section-left"></div>
{% for activity in site.data.agenda.tuesday %}
  {% capture thecycle %}{% cycle 'even', 'odd' %}{% endcapture %}
  {% if thecycle == 'odd' %}
  {% if activity == site.data.agenda.tuesday.last %}
    ...
    <div class="row activity-info-wrapper valign-wrapper">
      ...
      <div class="col m9 activity-info">
        ...
        <div class="col s12 activity-place">
          <i class="fa fa-map-marker"></i> <span> <h5><strong> {{ activity.place }} </strong></h5> </span>
        </div>
